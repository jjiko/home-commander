        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-8">
                  ...
                  <?php
                  $remoteAddr = (\Input::server('REMOTE_ADDR') == "127.0.0.1") ? file_get_contents("https://bot.whatismyipaddress.com/") : \Input::server('REMOTE_ADDR');
                  ?>
                    <input id="WAN" name="wan" class="form-control" type="text" value="{{ $remoteAddr }}" autocomplete="off">
